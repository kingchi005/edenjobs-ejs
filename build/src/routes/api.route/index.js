...
const applicant_route_1 = __importDefault(require("./applicant.route"));
const employer_route_1 = __importDefault(require("./employer.route"));
...
apiRoute.use("/applicant", applicant_route_1.default);
apiRoute.use("/employer", employer_route_1.default);
