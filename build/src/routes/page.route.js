...
pageRoute.get("/", (0, response_controller_1.middlewareWapper)(job_controller_1.getRecentJobs), (req, res) => {
    res.render("index", {
        title: "Find any kind of jobs in edenjobs",
        helper: { formatDate: helpers_controller_1.formatDate },
    });
});
pageRoute.get("/jobs", (0, response_controller_1.middlewareWapper)(job_controller_1.getJobs), (req, res) => {
    res.render("jobs", { title: "Edenjobs | jobs" });
});
pageRoute.get("/job/:id", (0, response_controller_1.middlewareWapper)(job_controller_1.getJobDetail), (req, res) => {
