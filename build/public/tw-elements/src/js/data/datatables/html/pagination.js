...
const pagination = ({ text, entries, entriesOptions, fullPagination, rowsText, allText, paginationStartIconTemplate, paginationLeftIconTemplate, paginationRightIconTemplate, paginationEndIconTemplate, classes, }, loading, bordered) => {
    const options = entriesOptions
        ...
        .join("\n");
    return `
<div class="${classes.pagination} ${bordered ? `${classes.paginationBordered}` : ""} ${classes.borderColor} ${classes.color}">
  <div class="${classes.selectItemsWrapper}">  
    <p class="${classes.paginationRowsText} ${loading ? `${classes.loadingPaginationRowsText}` : ""}">${rowsText}</p>
    <div class="${classes.selectWrapper} ${loading ? `${classes.loadingPaginationSelectWrapper}` : ""}">
      <select name="entries"
  ...
  <div class="${classes.paginationNav} ${loading ? `${classes.loadingPaginationNav}` : ""}" ${ATTR_PAGINATION_NAV}>
  ${text}
  </div>
  <div class="${classes.paginationButtonsWrapper}">
    ${fullPagination
        ...
        : ""}
    <button data-te-ripple-init data-te-ripple-color="dark" class="${classes.paginationLeftButton}" ${ATTR_PAGINATION_LEFT}>
      ${paginationLeftIconTemplate}
  </button>
    <button data-te-ripple-init data-te-ripple-color="dark" class="${classes.paginationRightButton}" ${ATTR_PAGINATION_RIGHT}>
