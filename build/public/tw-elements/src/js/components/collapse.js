...
const WIDTH = "width";
const HEIGHT = "height";
const SELECTOR_DATA_ACTIVES = "[data-te-collapse-item][data-te-collapse-show], [data-te-collapse-item][data-te-collapse-collapsing]";
...
class Collapse extends base_component_1.default {
    constructor(element, config, classes) {
        ...
        this._triggerArray = [];
        const toggleList = selector_engine_1.default.find(SELECTOR_DATA_COLLAPSE_INIT);
        for (let i = 0, len = toggleList.length; i < len; i++) {
            const elem = toggleList[i];
            const selector = (0, index_1.getSelectorFromElement)(elem);
            const filterElement = selector_engine_1.default.find(selector).filter((foundElem) => foundElem === this._element);
    ...
    show() {
        ...
        let activesData;
        if (this._config.parent) {
            const children = selector_engine_1.default.find(ATTR_COLLAPSE_DEEPER_CHILDREN, this._config.parent);
            actives = selector_engine_1.default.find(SELECTOR_DATA_ACTIVES, this._config.parent).filter((elem) => !children.includes(elem));
        }
        ...
        const CLASS_NAME_TRANSITION = dimension === "height"
            ? this._classes.collapsing
            : this._classes.collapsingHorizontal;
        manipulator_1.default.removeClass(this._element, this._classes.visible);
        manipulator_1.default.removeClass(this._element, this._classes.hidden);
        manipulator_1.default.addClass(this._element, CLASS_NAME_TRANSITION);
        ...
        const complete = () => {
            this._isTransitioning = false;
            manipulator_1.default.removeClass(this._element, this._classes.hidden);
            manipulator_1.default.removeClass(this._element, CLASS_NAME_TRANSITION);
            manipulator_1.default.addClass(this._element, this._classes.visible);
    ...
    hide() {
        ...
        const complete = () => {
            ...
            manipulator_1.default.removeClass(this._element, CLASS_NAME_TRANSITION);
            manipulator_1.default.addClass(this._element, this._classes.visible);
            manipulator_1.default.addClass(this._element, this._classes.hidden);
            this._element.removeAttribute(ATTR_COLLAPSING);
            this._element.setAttribute(ATTR_COLLAPSE_ITEM, "");
    ...
    _getConfig(config) {
        ...
        config.parent = (0, index_1.getElement)(config.parent);
    ...
    _initializeChildren() {
        ...
        const children = selector_engine_1.default.find(ATTR_COLLAPSE_DEEPER_CHILDREN, this._config.parent);
        selector_engine_1.default.find(SELECTOR_DATA_COLLAPSE_INIT, this._config.parent)
