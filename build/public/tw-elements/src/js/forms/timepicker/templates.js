...
exports.getToggleButtonTemplate = exports.getTimepickerTemplate = void 0;
const getTimepickerTemplate = ({ format24, okLabel, cancelLabel, headID, footerID, bodyID, pickerID, clearLabel, inline, showClearBtn, amLabel, pmLabel, }, classes) => {
    const normalTemplate = `<div id='${pickerID}' class='${classes.timepickerWrapper}' data-te-timepicker-wrapper>
      <div class="${classes.timepickerContainer}">
        <div class="${classes.timepickerElements}" data-te-timepicker-elements-wrapper>
      ...
      ${!inline
        ? `<div id='${bodyID}' class='${classes.timepickerClockWrapper}' data-te-timepicker-clock-wrapper>
    ...
    const inlineTemplate = `<div id='${pickerID}' class='${classes.timepickerInlineWrapper}' data-te-timepicker-wrapper>
        <div class="${classes.timepickerInlineContainer}">
          <div class="${classes.timepickerInlineElements}" data-te-timepicker-elements-wrapper>
...
exports.getTimepickerTemplate = getTimepickerTemplate;
const getToggleButtonTemplate = (options, id, classes) => {
