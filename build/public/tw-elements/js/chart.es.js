...
exports.v = exports.t = exports.r = exports.m = exports.i = exports.f = exports.e = exports.d = exports.c = exports.b = exports.a = exports.P = exports.B = exports.A = void 0;
function ct() {
}
const lo = function () {
    let i = 0;
...
const At = Object.create(null), pi = Object.create(null);
function te(i, t) {
    if (!t)
        return i;
    const e = t.split(".");
...
function Fi(i, t, e, s) {
    const n = t._rootScopes, o = Pn(t._fallback, e, s), r = [...i, ...n], a = new Set();
    a.add(s);
    let l = rs(a, r, e, o || e, s);
    return l === null || et(o) && o !== e && (l = rs(a, r, o, l, s), l === null) ? !1 : Ri(Array.from(a), [""], n, o, () => fr(t, e, s));
}
...
function Mr(i, t, e, s, n) {
    ...
    if (t.spanGaps && (i = i.filter((c) => !c.skip)), t.cubicInterpolationMode === "monotone")
        ...
        for (o = 0, r = i.length; o < r; ++o)
            a = i[o], l = br(c, a, i[Math.min(o + 1, r - (s ? 0 : 1)) % r], t.tension), a.cp1x = l.previous.x, a.cp1y = l.previous.y, a.cp2x = l.next.x, a.cp2y = l.next.y, c = a;
    }
...
class vt extends st {
    ...
    calculateLabelRotation() {
        ...
        a = t.offset ? this.maxWidth / s : f / (s - 1), d + 6 > a && (a = f / (s - (t.offset ? 0.5 : 1)), l = this.maxHeight - $t(t.grid) - e.padding - Ps(t.title, this.chart.options.font), c = Math.sqrt(d * d + u * u), r = Pi(Math.min(Math.asin(Y((h.highest.height + 6) / a, -1, 1)), Math.asin(Y(l / c, -1, 1)) - Math.asin(Y(u / c, -1, 1)))), r = Math.max(n, Math.min(o, r))), this.labelRotation = r;
    }
    ...
    drawGrid(t) {
        ...
        if (e.display)
            for (o = 0, r = n.length; o < r; ++o) {
                const l = n[o];
                e.drawOnChartArea && a({ x: l.x1, y: l.y1 }, { x: l.x2, y: l.y2 }, l), e.drawTicks && a({ x: l.tx1, y: l.ty1 }, { x: l.tx2, y: l.ty2 }, {
                    color: l.tickColor,
                    width: l.tickWidth,
...
function Gt(i, t, e, s) {
    ...
    for (o = 0, r = i.length, c = 0; o < r; ++o) {
        a = i[o], l = a.box, l.update(a.width || t.w, a.height || t.h, Ha(a.horizontal, t));
...
function ll(i, t) {
    const e = At[i.type] || { scales: {} }, s = t.scales || {}, n = xi(i.type, t), o = Object.create(null), r = Object.create(null);
...
class hl {
    constructor(t) {
        this._config = cl(t), this._scopeCache = new Map(), this._resolverCache = new Map();
    }
    get platform() {
    ...
    getOptionScopes(t, e, s) {
        ...
        return c.length === 0 && c.push(Object.create(null)), Zn.has(e) && r.set(e, c), c;
    }
    chartOptionScopes() {
    ...
    for (r = t; r < t + e; ++r) {
        ...
        if (_ === h)
            ...
            if (!T(d) && !T(u)) {
                ...
                k !== f && k !== M && m.push(Object.assign(Object.assign({}, i[k]), { x: n })), S !== f && S !== M && m.push(Object.assign(Object.assign({}, i[S]), { x: n }));
            }
...
function Dc(i) {
    ...
    i.setCenterPoint(t.l - e.l, e.r - t.r, t.t - e.t, e.b - t.b), i._pointLabelItems = Oc(i, s, n);
}
