...
const chart_es_js_1 = require("./chart.es.js");
var D = function () {
    if (typeof window < "u") {
...
`)) : Array.isArray(r) ? e.push.apply(e, r) : (0, chart_es_js_1.i)(e) || t.unshift("" + r);
        return t;
    },
...
function se(e) {
    return e instanceof chart_es_js_1.A ? E.arc : e instanceof chart_es_js_1.P ? E.point : e instanceof chart_es_js_1.B ? E.bar : E.fallback;
}
...
(0, chart_es_js_1.m)(L.prototype, {
    _modelize: function (e, t, r, a) {
        var i = this, n = i._index, o = (0, chart_es_js_1.t)((0, chart_es_js_1.r)([r.font, {}], a, n)), s = (0, chart_es_js_1.r)([r.color, chart_es_js_1.d.color], a, n);
        return {
            align: (0, chart_es_js_1.r)([r.align, "center"], a, n),
            anchor: (0, chart_es_js_1.r)([r.anchor, "center"], a, n),
            area: a.chart.chartArea,
            backgroundColor: (0, chart_es_js_1.r)([r.backgroundColor, null], a, n),
            borderColor: (0, chart_es_js_1.r)([r.borderColor, null], a, n),
            borderRadius: (0, chart_es_js_1.r)([r.borderRadius, 0], a, n),
            borderWidth: (0, chart_es_js_1.r)([r.borderWidth, 0], a, n),
            clamp: (0, chart_es_js_1.r)([r.clamp, !1], a, n),
            clip: (0, chart_es_js_1.r)([r.clip, !1], a, n),
            color: s,
            display: e,
            font: o,
            lines: t,
            offset: (0, chart_es_js_1.r)([r.offset, 4], a, n),
            opacity: (0, chart_es_js_1.r)([r.opacity, 1], a, n),
            origin: oe(i._el, a),
            padding: (0, chart_es_js_1.a)((0, chart_es_js_1.r)([r.padding, 4], a, n)),
            positioner: se(i._el),
            rotation: (0, chart_es_js_1.r)([r.rotation, 0], a, n) * (Math.PI / 180),
            size: m.textSize(i._ctx, t, o),
            textAlign: (0, chart_es_js_1.r)([r.textAlign, "start"], a, n),
            textShadowBlur: (0, chart_es_js_1.r)([r.textShadowBlur, 0], a, n),
            textShadowColor: (0, chart_es_js_1.r)([r.textShadowColor, s], a, n),
            textStrokeColor: (0, chart_es_js_1.r)([r.textStrokeColor, s], a, n),
            textStrokeWidth: (0, chart_es_js_1.r)([r.textStrokeWidth, 0], a, n)
        };
    },
    update: function (e) {
        var t = this, r = null, a = null, i = t._index, n = t._config, o, s, l, u = (0, chart_es_js_1.r)([n.display, !0], e, i);
        u && (o = e.dataset.data[i], s = (0, chart_es_js_1.v)((0, chart_es_js_1.c)(n.formatter, [o, e]), o), l = (0, chart_es_js_1.i)(s) ? [] : m.toTextLines(s), l.length && (r = t._modelize(u, l, n, e), a = ne(r))), t._model = r, t._rects = a;
    },
    geometry: function () {
...
(0, chart_es_js_1.m)(G.prototype, {
    ...
    intersects: function (e) {
        ...
        for (this._rotation !== e._rotation && a.push(I(r[0], r[1]), I(r[0], r[3])), i = 0; i < a.length; ++i)
...
var w = {
    ...
    if ((0, chart_es_js_1.i)(e))
        return null;
    var t = e, r, a, i;
    if ((0, chart_es_js_1.b)(e))
        if (!(0, chart_es_js_1.i)(e.label))
            t = e.label;
        else if (!(0, chart_es_js_1.i)(e.r))
            t = e.r;
        else
...
function pe(e, t) {
    ...
    return r === !1 ? null : (r === !0 && (r = {}), t = (0, chart_es_js_1.m)({}, [t, r]), n = t.labels || {}, o = Object.keys(n), delete t.labels, o.length ? o.forEach(function (s) {
        n[s] && i.push((0, chart_es_js_1.m)({}, [
            t,
            n[s],
            { _key: s }
        ]));
    }) : i.push(t), a = i.reduce(function (s, l) {
        return (0, chart_es_js_1.e)(l.listeners || {}, function (u, v) {
...
function R(e, t, r, a) {
    if (t) {
        ...
        t[n._set] && (o = t[n._set][n._key], o && (0, chart_es_js_1.c)(o, [i, a]) === !0 && (e[h]._dirty = !0, r.update(i)));
    }
}
...
var Me = {
    ...
    afterDatasetUpdate: function (e, t, r) {
        ...
        v.restore(), (0, chart_es_js_1.m)(i._listeners, l.listeners, {
