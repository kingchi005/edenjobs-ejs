...
(function (global, factory) {
                ...
                var altKey = hyphenate(key);
                {
                    ...
                    if (key !== keyInLowerCase && attrs && hasOwn(attrs, keyInLowerCase)) {
                        tip("Prop \"".concat(keyInLowerCase, "\" is passed to component ") +
                            "".concat(formatComponentName(tag || Ctor), ", but the declared prop name is") +
                            " \"".concat(key, "\". ") +
    ...
    var Watcher = (function () {
        function Watcher(vm, expOrFn, cb, options, isRenderWatcher) {
            recordEffectScope(this, activeEffectScope && !activeEffectScope._vm
                ? activeEffectScope
                : vm
                    ? vm._scope
                    : undefined);
    ...
    function createComponent(Ctor, data, context, children, tag) {
        ...
        var vnode = new VNode("vue-component-".concat(Ctor.cid).concat(name ? "-".concat(name) : ''), data, undefined, undefined, undefined, context, { Ctor: Ctor, propsData: propsData, listeners: listeners, tag: tag, children: children }, asyncFactory);
        return vnode;
    }
    ...
    var KeepAlive = {
        ...
        render: function () {
            ...
            if (componentOptions) {
                ...
                if ((include && (!name_2 || !matches(include, name_2))) ||
